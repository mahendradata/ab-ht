#!/bin/bash
# --------------------------------------------------------------
# This script download a CIC-IDS2017 MachineLearningCSV dataset.
#
# Author: Mahendra Data - mahendra.data@dbms.cs.kumamoto-u.ac.jp
# License: BSD 3 clause
#
# Example: "bash CIC-IDS2017-download.sh"
# --------------------------------------------------------------

NAME="CIC-IDS2017-MachineLearning"

echo "Downloading CIC-IDS2017. If the dataset already downloaded, then skip it."
wget -nc -O $NAME.zip \
